...
//   const sendChannelBtn = page.locator('.modal-footer button[type="submit"]').first();
...
//   const renameChannelBtn = page.locator('.modal-footer button[type="submit"]').first();
...
//   const sendMessageButton = page.locator('button[type="submit"]').first();
